...
bool ShapeContainer::intersect(Ray& r, float tmin, float tmax, HitStruct &hit) {
...
void ShapeContainer::getTextureCoordinates
...
BoundingBox ShapeContainer::buildTree() {
    if (shapeCount() > 2) {
        double center = 0;
        double gap = 0;
        double range;
        ...
        ShapeContainer * b = new ShapeContainer();
        int aCount = 0;
        int bCount = 0;
...
vector <double> ShapeContainer::sortGaps(int ax) {
    vector <double> gaps;
